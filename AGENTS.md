...
## 📊 2. Текущий статус проекта (Главы 1–60 завершены, 5 291 / 7 071 упр. — 74.8%)

* **Готово глав:** 60 из 83 (72.3%)
* **Готово упражнений:** 5 291 из 7 071 (74.8%)
* **Осталось глав:** 23 (1 780 упражнений)
...
| **61** | Документоориентированная база данных MongoDB | `61. Документоориентированная база данных MongoDB.md` | `chapter61.html` | 113 | ⏳ Следующая глава |
...
├── chapter60.html                 # Глава 60 (63 упр.)
├── chapter61.html                 # Глава 61 (генерируется следующей)
