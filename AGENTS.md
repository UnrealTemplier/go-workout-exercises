...
## 📊 2. Текущий статус проекта (Главы 1–57 завершены, 5 106 / 7 071 упр. — 72.2%)

* **Готово глав:** 57 из 83 (68.7%)
* **Готово упражнений:** 5 106 из 7 071 (72.2%)
* **Осталось глав:** 26 (1 965 упражнений)
...
| **58** | Хеширование паролей и криптографическая стойкость | `58. Хеширование паролей и криптографическая стойкость.md` | `chapter58.html` | 56 | ⏳ Следующая глава |
...
├── chapter57.html                 # Глава 57 (100 упр.)
├── chapter58.html                 # Глава 58 (генерируется следующей)
