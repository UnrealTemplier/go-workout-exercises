...
## 📊 2. Текущий статус проекта (Главы 1–72 завершены, 6 292 / 7 071 упр. — 89.0%)

* **Готово глав:** 72 из 83 (86.7%)
* **Готово упражнений:** 6 292 из 7 071 (89.0%)
* **Осталось глав:** 11 (779 упражнений)
...
| **73** | Распределенные блокировки и Fencing Tokens | `73. Распределенные блокировки и Fencing Tokens.md` | `chapter73.html` | 68 | ⏳ Следующая глава |
...
├── chapter72.html                 # Глава 72 (83 упр.)
├── chapter73.html                 # Глава 73 (генерируется следующей)
