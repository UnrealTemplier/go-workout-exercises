...
## 📊 2. Текущий статус проекта (Главы 1–76 завершены, 6 569 / 7 071 упр. — 92.9%)

* **Готово глав:** 76 из 83 (91.6%)
* **Готово упражнений:** 6 569 из 7 071 (92.9%)
* **Осталось глав:** 7 (502 упражнения)
...
| **77** | Высокопроизводительные сетевые фреймворки (gnet, evio) | `77. Высокопроизводительные сетевые фреймворки (gnet, evio).md` | `chapter77.html` | 32 | ⏳ Следующая глава |
...
├── chapter76.html                 # Глава 76 (35 упр.)
├── chapter77.html                 # Глава 77 (генерируется следующей)
