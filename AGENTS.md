...
## 📊 2. Текущий статус проекта (Главы 1–15 завершены)

На данный момент в учебнике полностью готово **15 глав** и **1 079 упражнений** (100% покрытие исходных файлов, 0 пропусков):
...
| **16** | Дженерики | `16. Дженерики.md` | `chapter16.html` | *TBD* | ⏳ Следующая глава |
