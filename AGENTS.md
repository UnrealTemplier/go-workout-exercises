...
* **Целевой объем курса:** 100 глав (~7 600 упражнений)
* **Готово глав:** 83 из 100 (100.0% от базового корпуса глав 1–83)
* **Готово упражнений:** 7 071 из 7 071 в готовых главах
* **В плане (дорожная карта расширения):** 17 глав (Главы 84–100, по 30–35 упражнений в каждой)
...
| **84** | CQRS и Event Sourcing на Go | `84. CQRS и Event Sourcing на Go.md` | `chapter84.html` | 30 | 📋 В плане |
| **85** | Многоуровневое кэширование (L1/L2) и распределенная когерентность | `85. Многоуровневое кэширование (L1/L2) и распределенная когерентность.md` | `chapter85.html` | 30 | 📋 В плане |
| **86** | Масштабируемые распределенные планировщики и очереди задач | `86. Масштабируемые распределенные планировщики и очереди задач.md` | `chapter86.html` | 30 | 📋 В плане |
| **87** | Оркестрация распределенных процессов (Durable Execution) на Temporal.io | `87. Оркестрация распределенных процессов (Durable Execution) на Temporal.io.md` | `chapter87.html` | 30 | 📋 В плане |
| **88** | Потоковая обработка данных в реальном времени (Stream Processing) | `88. Потоковая обработка данных в реальном времени (Stream Processing).md` | `chapter88.html` | 30 | 📋 В плане |
| **89** | Хаос-инженерия и нагрузочное тестирование на Go | `89. Хаос-инженерия и нагрузочное тестирование на Go.md` | `chapter89.html` | 30 | 📋 В плане |
| **90** | Контракт-ориентированные API-шлюзы: gRPC-Gateway, gRPC-Web и OpenAPI | `90. Контракт-ориентированные API-шлюзы: gRPC-Gateway, gRPC-Web и OpenAPI.md` | `chapter90.html` | 30 | 📋 В плане |
| **91** | Разработка собственных Kubernetes Operators и CRD на Go | `91. Разработка собственных Kubernetes Operators и CRD на Go.md` | `chapter91.html` | 30 | 📋 В плане |
| **92** | Расширяемость систем: Plugins, IPC и WebAssembly (Wazero) | `92. Расширяемость систем: Plugins, IPC и WebAssembly (Wazero).md` | `chapter92.html` | 30 | 📋 В плане |
| **93** | Высокопроизводительные API Gateway и Reverse Proxy на чистом Go | `93. Высокопроизводительные API Gateway и Reverse Proxy на чистом Go.md` | `chapter93.html` | 30 | 📋 В плане |
| **94** | Enterprise Release Engineering: Feature Flags, динамический конфиг и Canary Routing | `94. Enterprise Release Engineering: Feature Flags, динамический конфиг и Canary Routing.md` | `chapter94.html` | 30 | 📋 В плане |
| **95** | Распределенная координация и хранилище метаданных etcd v3 | `95. Распределенная координация и хранилище метаданных etcd v3.md` | `chapter95.html` | 30 | 📋 В плане |
| **96** | Zero-Downtime миграции баз данных и паттерн Expand/Contract на Go | `96. Zero-Downtime миграции баз данных и паттерн Expand/Contract на Go.md` | `chapter96.html` | 30 | 📋 В плане |
| **97** | Time-Series СУБД, сжатие Gorilla и IoT-телеметрия на Go | `97. Time-Series СУБД, сжатие Gorilla и IoT-телеметрия на Go.md` | `chapter97.html` | 30 | 📋 В плане |
| **98** | Архитектурный контроль: Разработка корпоративных линтеров для golangci-lint | `98. Архитектурный контроль: Разработка корпоративных линтеров для golangci-lint.md` | `chapter98.html` | 30 | 📋 В плане |
| **99** | Интеграция с ИИ, LLM-оркестрация и векторный поиск на Go | `99. Интеграция с ИИ, LLM-оркестрация и векторный поиск на Go.md` | `chapter99.html` | 30 | 📋 В плане |
| **100** | Архитектурный Capstone: Проектирование и сквозной запуск отказоустойчивой HighLoad-платформы | `100. Архитектурный Capstone: Проектирование и сквозной запуск отказоустойчивой HighLoad-платформы.md` | `chapter100.html` | 35 | 📋 В плане |
