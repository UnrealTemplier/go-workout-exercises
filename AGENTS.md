...
## 📊 2. Текущий статус проекта (Главы 1–82 завершены, 7 043 / 7 071 упр. — 99.6%)

* **Готово глав:** 82 из 83 (98.8%)
* **Готово упражнений:** 7 043 из 7 071 (99.6%)
* **Осталось глав:** 1 (28 упражнений)
...
| **83** | Системная изоляция, Seccomp и Linux Capabilities | `83. Системная изоляция, Seccomp и Linux Capabilities.md` | `chapter83.html` | 28 | ⏳ Следующая глава |
...
├── chapter82.html                 # Глава 82 (55 упр.)
├── chapter83.html                 # Глава 83 (генерируется следующей)
