...
## 📊 2. Текущий статус проекта (Главы 1–51 завершены, 4 585 / 7 071 упр. — 64.8%)

* **Готово глав:** 51 из 83 (61.4%)
* **Готово упражнений:** 4 585 из 7 071 (64.8%)
* **Осталось глав:** 32 (2 486 упражнений)
...
| **52** | Интеграция с C-кодом через CGO | `52. Интеграция с C-кодом через CGO.md` | `chapter52.html` | 70 | ⏳ Следующая глава |
...
├── chapter52.html                # Глава 52 (генерируется следующей)
