...
## 📊 2. Текущий статус проекта (Главы 1–36 завершены)

На данный момент в учебнике полностью готово **36 глав** и **3 286 упражнений** (100% покрытие исходных файлов, 0 пропусков):
...
| **37** | Apache Kafka | `37. Apache Kafka.md` | `chapter37.html` | *TBD* | ⏳ Следующая глава |
