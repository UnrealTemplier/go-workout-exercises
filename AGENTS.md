...
## 📊 2. Текущий статус проекта (Главы 1–75 завершены, 6 534 / 7 071 упр. — 92.4%)

* **Готово глав:** 75 из 83 (90.4%)
* **Готово упражнений:** 6 534 из 7 071 (92.4%)
* **Осталось глав:** 8 (537 упражнений)
...
| **76** | Ассемблер Go (Plan 9 Assembly) и SIMD | `76. Ассемблер Go (Plan 9 Assembly) и SIMD.md` | `chapter76.html` | 35 | ⏳ Следующая глава |
...
├── chapter75.html                 # Глава 75 (75 упр.)
├── chapter76.html                 # Глава 76 (генерируется следующей)
