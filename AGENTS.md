...
## 📊 2. Текущий статус проекта (Главы 1–37 завершены)

На данный момент в учебнике полностью готово **37 глав** и **3 374 упражнений** (100% покрытие исходных файлов, 0 пропусков):
...
| **38** | NATS и NATS JetStream | `38. NATS и NATS JetStream.md` | `chapter38.html` | *TBD* | ⏳ Следующая глава |
