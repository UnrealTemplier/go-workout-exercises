...
## 📊 2. Текущий статус проекта (Главы 1–28 завершены)

На данный момент в учебнике полностью готово **28 глав** и **2 399 упражнений** (100% покрытие исходных файлов, 0 пропусков):
...
| **29** | Очереди сообщений и брокеры (RabbitMQ и Kafka) | `29. Очереди сообщений и брокеры (RabbitMQ и Kafka).md` | `chapter29.html` | *TBD* | ⏳ Следующая глава |
