...
## 📊 2. Текущий статус проекта (Главы 1–23 завершены)

На данный момент в учебнике полностью готово **23 главы** и **1 855 упражнений** (100% покрытие исходных файлов, 0 пропусков):
...
| **24** | Низкоуровневая сеть | `24. Низкоуровневая сеть (TCP и UDP).md` | `chapter24.html` | *TBD* | ⏳ Следующая глава |
