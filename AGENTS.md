...
## 📊 2. Текущий статус проекта (Главы 1–47 завершены, 4 254 / 7 071 упр. — 60.2%)

* **Готово глав:** 47 из 83 (56.6%)
* **Готово упражнений:** 4 254 из 7 071 (60.2%)
* **Осталось глав:** 36 (2 817 упражнений)
...
| **48** | Планировщик GMP | `48. Планировщик GMP.md` | `chapter48.html` | 93 | ⏳ Следующая глава |
| **49** | Аллокатор кучи и управление памятью | `49. Аллокатор кучи и управление памятью.md` | `chapter49.html` | 66 | ⏳ В очереди |
| **50** | Garbage Collector и тюнинг памяти | `50. Garbage Collector и тюнинг памяти.md` | `chapter50.html` | 87 | ⏳ В очереди |
| **51** | Работа с unsafe и низкоуровневой памятью | `51. Работа с unsafe и низкоуровневой памятью.md` | `chapter51.html` | 85 | ⏳ В очереди |
| **52** | Интеграция с C-кодом через CGO | `52. Интеграция с C-кодом через CGO.md` | `chapter52.html` | 70 | ⏳ В очереди |
| **53** | Системные вызовы и взаимодействие с ОС | `53. Системные вызовы и взаимодействие с ОС.md` | `chapter53.html` | 75 | ⏳ В очереди |
...
├── chapter48.html                # Глава 48 (генерируется следующей)
