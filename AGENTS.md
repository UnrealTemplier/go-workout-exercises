...
## 📊 2. Текущий статус проекта (Главы 1–64 завершены, 5 592 / 7 071 упр. — 79.1%)

* **Готово глав:** 64 из 83 (77.1%)
* **Готово упражнений:** 5 592 из 7 071 (79.1%)
* **Осталось глав:** 19 (1 479 упражнений)
...
| **65** | Вебхуки и платформы обратных вызовов | `65. Вебхуки и платформы обратных вызовов.md` | `chapter65.html` | 116 | ⏳ Следующая глава |
...
├── chapter64.html                 # Глава 64 (57 упр.)
├── chapter65.html                 # Глава 65 (генерируется следующей)
