...
## 📊 2. Текущий статус проекта (Главы 1–73 завершены, 6 360 / 7 071 упр. — 90.0%)

* **Готово глав:** 73 из 83 (88.0%)
* **Готово упражнений:** 6 360 из 7 071 (90.0%)
* **Осталось глав:** 10 (711 упражнений)
...
| **74** | Cache-friendly структуры данных и выравнивание памяти | `74. Cache-friendly структуры данных и выравнивание памяти.md` | `chapter74.html` | 99 | ⏳ Следующая глава |
...
├── chapter73.html                 # Глава 73 (68 упр.)
├── chapter74.html                 # Глава 74 (генерируется следующей)
