...
## 📊 2. Текущий статус проекта (Главы 1–68 завершены, 5 973 / 7 071 упр. — 84.5%)

* **Готово глав:** 68 из 83 (81.9%)
* **Готово упражнений:** 5 973 из 7 071 (84.5%)
* **Осталось глав:** 15 (1 098 упражнений)
...
| **69** | Паттерны Outbox и Inbox для надежной доставки сообщений | `69. Паттерны Outbox и Inbox для надежной доставки сообщений.md` | `chapter69.html` | 72 | ⏳ Следующая глава |
...
├── chapter68.html                 # Глава 68 (104 упр.)
├── chapter69.html                 # Глава 69 (генерируется следующей)
