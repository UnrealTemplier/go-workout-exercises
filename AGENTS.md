...
## 📊 2. Текущий статус проекта (Главы 1–81 завершены, 6 988 / 7 071 упр. — 98.8%)

* **Готово глав:** 81 из 83 (97.6%)
* **Готово упражнений:** 6 988 из 7 071 (98.8%)
* **Осталось глав:** 2 (83 упражнения)
...
| **82** | Защита сетевых сокетов и противодействие DoS-атакам | `82. Защита сетевых сокетов и противодействие DoS-атакам.md` | `chapter82.html` | 55 | ⏳ Следующая глава |
...
├── chapter80.html                 # Глава 80 (76 упр.)
├── chapter81.html                 # Глава 81 (136 упр.)
├── chapter82.html                 # Глава 82 (генерируется следующей)
