...
## 📊 2. Текущий статус проекта (Главы 1–69 завершены, 6 045 / 7 071 упр. — 85.5%)

* **Готово глав:** 69 из 83 (83.1%)
* **Готово упражнений:** 6 045 из 7 071 (85.5%)
* **Осталось глав:** 14 (1 026 упражнений)
...
| **70** | Проектирование идемпотентных API | `70. Проектирование идемпотентных API.md` | `chapter70.html` | 74 | ⏳ Следующая глава |
...
├── chapter69.html                 # Глава 69 (72 упр.)
├── chapter70.html                 # Глава 70 (генерируется следующей)
