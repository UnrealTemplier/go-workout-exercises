...
## 📊 2. Текущий статус проекта (Главы 1–56 завершены, 5 006 / 7 071 упр. — 70.8%)

* **Готово глав:** 56 из 83 (67.5%)
* **Готово упражнений:** 5 006 из 7 071 (70.8%)
* **Осталось глав:** 27 (2 065 упражнений)
...
| **57** | Симметричное и асимметричное шифрование | `57. Симметричное и асимметричное шифрование.md` | `chapter57.html` | 100 | ⏳ Следующая глава |
...
├── chapter56.html                # Глава 56 (77 упр.)
├── chapter57.html                # Глава 57 (генерируется следующей)
