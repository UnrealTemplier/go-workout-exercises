...
## 📊 2. Текущий статус проекта (Главы 1–59 завершены, 5 228 / 7 071 упр. — 73.9%)

* **Готово глав:** 59 из 83 (71.1%)
* **Готово упражнений:** 5 228 из 7 071 (73.9%)
* **Осталось глав:** 24 (1 843 упражнений)
...
| **60** | Безопасность веб-приложений и защита API | `60. Безопасность веб-приложений и защита API.md` | `chapter60.html` | 63 | ⏳ Следующая глава |
...
├── chapter58.html                 # Глава 58 (56 упр.)
├── chapter59.html                 # Глава 59 (66 упр.)
├── chapter60.html                 # Глава 60 (генерируется следующей)
