...
## 📊 2. Текущий статус проекта (Главы 1–26 завершены)

На данный момент в учебнике полностью готово **26 глав** и **2 121 упражнение** (100% покрытие исходных файлов, 0 пропусков):
...
| **27** | Реляционные базы данных (SQL и PostgreSQL) | `27. Реляционные базы данных (SQL и PostgreSQL).md` | `chapter27.html` | *TBD* | ⏳ Следующая глава |
