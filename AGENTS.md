...
## 📊 2. Текущий статус проекта (Главы 1–50 завершены, 4 500 / 7 071 упр. — 63.6%)

* **Готово глав:** 50 из 83 (60.2%)
* **Готово упражнений:** 4 500 из 7 071 (63.6%)
* **Осталось глав:** 33 (2 571 упражнение)
...
| **51** | Работа с unsafe и низкоуровневой памятью | `51. Работа с unsafe и низкоуровневой памятью.md` | `chapter51.html` | 85 | ⏳ Следующая глава |
...
├── chapter51.html                # Глава 51 (генерируется следующей)
