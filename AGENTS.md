...
## 📊 2. Текущий статус проекта (Главы 1–24 завершены)

На данный момент в учебнике полностью готово **24 главы** и **1 918 упражнений** (100% покрытие исходных файлов, 0 пропусков):
...
| **25** | HTTP-клиент | `25. HTTP-клиент.md` | `chapter25.html` | *TBD* | ⏳ Следующая глава |
