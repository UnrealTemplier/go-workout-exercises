...
## 📊 2. Текущий статус проекта (Главы 1–66 завершены, 5 777 / 7 071 упр. — 81.7%)

* **Готово глав:** 66 из 83 (79.5%)
* **Готово упражнений:** 5 777 из 7 071 (81.7%)
* **Осталось глав:** 17 (1 294 упражнения)
...
| **67** | Альтернативные RPC-протоколы | `67. Альтернативные RPC-протоколы.md` | `chapter67.html` | 92 | ⏳ Следующая глава |
...
├── chapter66.html                 # Глава 66 (69 упр.)
├── chapter67.html                 # Глава 67 (генерируется следующей)
