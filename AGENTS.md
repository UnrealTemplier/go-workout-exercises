...
## 📊 2. Текущий статус проекта (Главы 1–65 завершены, 5 708 / 7 071 упр. — 80.7%)

* **Готово глав:** 65 из 83 (78.3%)
* **Готово упражнений:** 5 708 из 7 071 (80.7%)
* **Осталось глав:** 18 (1 363 упражнения)
...
| **66** | Server-Sent Events | `66. Server-Sent Events.md` | `chapter66.html` | 69 | ⏳ Следующая глава |
...
├── chapter65.html                 # Глава 65 (116 упр.)
├── chapter66.html                 # Глава 66 (генерируется следующей)
