...
* **В очереди генерации интерактивных глав:** 17 глав (Главы 84–100, 595 упражнений)
...
| **84** | CQRS и Event Sourcing на Go | `84. CQRS и Event Sourcing на Go.md` | `chapter84.html` | 45 | 📝 Задачник готов (45/45) |
...
| **87** | Оркестрация распределенных процессов (Durable Execution) на Temporal.io | `87. Оркестрация распределенных процессов (Durable Execution) на Temporal.io.md` | `chapter87.html` | 50 | 📝 Задачник готов (50/50) |
