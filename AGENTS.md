...
## 📊 2. Текущий статус проекта (Главы 1–21 завершены)

На данный момент в учебнике полностью готово **21 глава** и **1 671 упражнение** (100% покрытие исходных файлов, 0 пропусков):
...
| **22** | Контекст | `22. Контекст.md` | `chapter22.html` | *TBD* | ⏳ Следующая глава |
