...
## 📊 2. Текущий статус проекта (Главы 1–78 завершены, 6 696 / 7 071 упр. — 94.7%)

* **Готово глав:** 78 из 83 (94.0%)
* **Готово упражнений:** 6 696 из 7 071 (94.7%)
* **Осталось глав:** 5 (375 упражнений)
...
| **79** | Интеграция с Service Mesh (Istio, Linkerd) и mTLS | `79. Интеграция с Service Mesh (Istio, Linkerd) и mTLS.md` | `chapter79.html` | 80 | ⏳ Следующая глава |
...
├── chapter78.html                 # Глава 78 (95 упр.)
├── chapter79.html                 # Глава 79 (генерируется следующей)
